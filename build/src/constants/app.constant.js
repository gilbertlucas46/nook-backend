    ...
    SUCCESS: {
        S200: {
            ...
            LOGIN_TEST: (language) => {
                let body = {
                    statusCode: 200,
                    message: (language == exports.DATABASE.LANGUAGE.EN) ? 'Logged In Successfully' : 'Амжилтанд хүрсэн',
                    type: 'LOGIN'
                };
                return body;
            },
...
exports.SERVER = {
    ...
    SHARE_CONTENT: {
        ...
        SHARE_CONTENT_LINK: config.get("host") + exports.DATABASE.DEEPLINK_REDIRECT_URL.APP + "http://nook.com" + "/" + exports.DATABASE.ACTION.DEEPLINK.APP + "&ios=" + "nook://" + exports.DATABASE.ACTION.DEEPLINK.APP
    },
