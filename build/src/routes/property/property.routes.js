...
exports.propertyRoute = [
        ...
        handler: async (request, h) => {
            try {
                ...
                if (payload.propertyId) {
                    let registerResponse = await controllers_1.PropertyService.addProperty(payload, userData);
    ...
    },
    {
        ...
        handler: async (request, h) => {
            try {
                let propertyList = await controllers_1.PropertyService.searchProperties(request.query);
    ...
    },
    {
        ...
        handler: async (request, h) => {
            try {
                let data = await controllers_1.PropertyService.nearbyProperties(request.query);
    ...
    },
    {
        ...
        handler: async (request, h) => {
            try {
                ...
                let data = await controllers_1.PropertyService.userPropertyByStatus(payload, userData);
    ...
    },
    {
        ...
        handler: async (request, h) => {
            try {
                ...
                let payload = request.payload;
                if (payload.propertyId) {
                    let registerResponse = await controllers_1.PropertyService.saveAsDraft(payload, userData);
                    return (UniversalFunctions.sendSuccess(Constant.STATUS_MSG.SUCCESS.S200.UPDATED, registerResponse));
                }
                else {
                    let registerResponse = await controllers_1.PropertyService.saveAsDraft(payload, userData);
    ...
    },
    {
        ...
        handler: async (request, h) => {
            try {
                ...
                let data = await controllers_1.PropertyService.updatePropertyStatus(payload, userData);
                return (UniversalFunctions.sendSuccess(Constant.STATUS_MSG.SUCCESS.S200.DEFAULT, data));
            }
            catch (error) {
                return (UniversalFunctions.sendError(error));
