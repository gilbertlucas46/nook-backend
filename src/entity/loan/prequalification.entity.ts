...
class PreLoanEntities extends BaseEntity {
            ...
            if (data.length > 0) {
                ...
                if (payload.preQualificationId) {
                    ...
                    console.log('zapier_loanUrlzapier_loanUrl', config.get('zapier_loanUrl'), config.get('environment'));
                     ...
                     console.log('salesforceDatasalesforceDatasalesforceData====> prequalification', salesforceData);
    ...
    async adminAddBanks(payload: PreQualificationRequest.IPreLoanAdd, userData) {
        try {
            ...
            // []; // Max age is 65 till the final loan payment.
            ...
            payload['grossIncome'] = totalMonthlyIncome;
            payload['totalLoanMonthly'] = (data && data[0] && data[0]['totalLoanMonthly']) ? data[0]['totalLoanMonthly'] : 0;
            payload['monthlyPayment'] = (data && data[0] && data[0]['monthlyPayment']) ? data[0]['monthlyPayment'] : 0;
