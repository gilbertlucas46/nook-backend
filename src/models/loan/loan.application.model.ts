...
const schema = new Schema({
    ...
    employmentInfo: {
        companyIndustry: {
            type: Schema.Types.String, enum: [
                CONSTANT.INDUSTRIES.AGRI_FOREST_FISH.value,
                CONSTANT.INDUSTRIES.ADVERTISING.value,
                CONSTANT.INDUSTRIES.BUSINESS_INFORMATION.value,
                CONSTANT.INDUSTRIES.CONST_UTIL_CONTRACT.value,
                CONSTANT.INDUSTRIES.EDUCATION.value,
                CONSTANT.INDUSTRIES.ENTERTAINMENT_FASHION.value,
                CONSTANT.INDUSTRIES.FINANCE_INSURANCE.value,
                CONSTANT.INDUSTRIES.FOOD_HOSPITALITY.value,
                CONSTANT.INDUSTRIES.GAMING.value,
                CONSTANT.INDUSTRIES.HEALTH_SERVICES.value,
                CONSTANT.INDUSTRIES.INFORMATION_TECHNOLOGY.value,
                CONSTANT.INDUSTRIES.MANUFACTURING.value,
                CONSTANT.INDUSTRIES.MOTOR_VEHICLE.value,
                CONSTANT.INDUSTRIES.MUSIC_MEDIA.value,
                CONSTANT.INDUSTRIES.NATURAL_RES_ENV.value,
                CONSTANT.INDUSTRIES.OTHER.value,
                CONSTANT.INDUSTRIES.PERSONAL_SERVICES.value,
                CONSTANT.INDUSTRIES.REAL_ESTATE_HOUSING.value,
                CONSTANT.INDUSTRIES.RETAIL.value,
                CONSTANT.INDUSTRIES.SAFETY_SECURITY_LEGAL.value,
                CONSTANT.INDUSTRIES.TRANSPORTATION.value,
            ],
        },
